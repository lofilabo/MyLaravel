...
var dragitemoneline = `<a class="edit-item-trigger-clicked" id='uniqueid-item--RANDOMTOKEN'>EDIT</a>  <a class="remove-item-trigger-clicked" id='uniqueid-itemm--RANDOMTOKEN'>| REMOVE</a>`;
//var dragitemoneline = '<div class="list-group-item nested-3">Item 999</div>';
//var dragitemoneline = `<div class="list-group-item"><a class="edit-item-trigger-clicked" id='uniqueid-item--RANDOMTOKEN'>EDIT</a></div>`;
      ...
      $('.clickxxxxx').click( function(e){
        ...
        $('#veryTopOfList').html(  thisline);
      } );
      $('.clickxxxxy').click( function(e){
        var rndunq = getRndInteger(10000,99999);
        var today = new Date();
        var date = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate();
        var time = today.getHours() + "-" + today.getMinutes() + "-" + today.getSeconds();
        ...
        console.log('fizzzzzzzzzzzzzzzzzzzzzzz');
        thisline = dragitemoneline.replace(/RANDOMTOKEN/g, uniqueID);
        $('#nextItemInList').html(  thisline  +  $('#veryTopOfList').html() );
      } );
      ...
      function restoreFromStorage(){  
        ...
        //console.log( innercontentsLHS_DATA );
        $("#simple-list").html(innercontentsLHS_HTML);  
        ...
        //console.log("Heere");
        innercontentsLHS_HTML = $("#simple-list").html();
